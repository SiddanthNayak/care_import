...
const moduleMap = {'react':{get:()=>()=>__federation_import(new URL('__federation_shared_react.js', import.meta.url).href),import:true},'react-dom':{get:()=>()=>__federation_import(new URL('__federation_shared_react-dom.js', import.meta.url).href),import:true},'react-i18next':{get:()=>()=>__federation_import(new URL('__federation_shared_react-i18next.js', import.meta.url).href),import:true},'@tanstack/react-query':{get:()=>()=>__federation_import(new URL('__federation_shared_@tanstack/react-query.js', import.meta.url).href),import:true},'raviger':{get:()=>()=>__federation_import(new URL('__federation_shared_raviger.js', import.meta.url).href),import:true}};
